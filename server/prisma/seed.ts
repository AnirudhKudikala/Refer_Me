...
const seekerData = [
  { fullName: "Alex Chen", headline: "Full Stack Engineer", skills: ["React", "Node.js", "TypeScript", "PostgreSQL"], desiredRoles: ["Software Engineer", "Full Stack Developer"], experienceYears: 4, location: "San Francisco, CA", bio: "Passionate about building scalable web applications.", noticePeriod: "30 days", salaryExpectation: "₹14 LPA" },
  { fullName: "Priya Sharma", headline: "Backend Developer", skills: ["Python", "Django", "AWS", "Docker"], desiredRoles: ["Backend Engineer", "DevOps Engineer"], experienceYears: 3, location: "New York, NY", bio: "Experienced in cloud infrastructure and API design.", noticePeriod: "60 days", salaryExpectation: "₹12 LPA" },
  { fullName: "Marcus Johnson", headline: "Frontend Specialist", skills: ["React", "Vue", "CSS", "Figma"], desiredRoles: ["Frontend Engineer", "UI Engineer"], experienceYears: 5, location: "Austin, TX", bio: "Crafting beautiful, accessible user interfaces.", noticePeriod: "Immediate", salaryExpectation: "₹13 LPA", immediateJoining: true },
